...
<section><h2>Touch diagnostics</h2><p>Live GT911 and I²C data, refreshed every two seconds. Tap the display once and watch whether the counters change.</p><div class=usage-main id=touchMain>Loading...</div><pre class=diag id=touchDetail>Waiting for diagnostics...</pre></section>
...
void webBegin(AppConfig &c, bool setupMode){
 ...
 server.on("/api/touch",HTTP_GET,[]{
   ...
   d["callback_calls"]=t.callbackCalls; d["probe_attempts"]=t.probeAttempts; d["polls"]=t.polls;
