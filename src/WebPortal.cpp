...
fetch('/api/status').then(r=>r.json()).then(s=>{q('[name=background_color]').value=s.background_color||'#000000';if(q('#buildVersion'))q('#buildVersion').textContent=s.version||'0.8.24.2318'});
